...
<div class="container">
	...
	<header id="navtop">
		...
		<nav class="fright">
				<?php 
                    include(Yii::getPathOfAlias('webroot') . 
                        DIRECTORY_SEPARATOR . 'themes/menuWidget.php'); 
                ?>
		</nav>
	</header>
...
<div class="home-page main">
	...
	<section class="services grid-wrap">
		...
		<article class="grid col-one-third mq3-col-full">
			<aside>01</aside>
			<h5>Web design</h5>
			<p>We used a theme by <a href="http://yii.themefactory.net/theme/132/designa#.U5H2thbRbfY">DesignA</a></p>
		</article>
		
		<article class="grid col-one-third mq3-col-full">
			<aside>02</aside>
			<h5>Web development</h5>
			<p>The MOSS Guys: Diogo, Luis and Rénan</p>
		</article>
		
		<article class="grid col-one-third mq3-col-full">
			<aside>03</aside>
			<h5>Graphic design</h5>
			<p>Again, by the theme guys ^^</p>
		</article>
	</section>
	...
	<header class="grid col-full">
			...
			<figure class="grid col-one-quarter mq2-col-one-half">
				...
				<figcaption>
					...
					<p>Some project we were supposed to do</p>
				</figcaption>
			</figure>
			...
			<figure class="grid col-one-quarter mq2-col-one-half">
				...
				<figcaption>
					...
					<p>Like, a project for the X-Man</p>
				</figcaption>
			</figure>
			...
			<figure class="grid col-one-quarter mq2-col-one-half">
				...
				<figcaption>
					<a href="#" class="arrow">Project Y</a>
					<p>Why, God, why?</p>
				</figcaption>
			</figure>
			...
			<figure class="grid col-one-quarter mq2-col-one-half">
				...
				<figcaption>
					<a href="#" class="arrow">Project W</a>
					<p>Our favourite project!</p>
				</figcaption>
			</figure>
	</section>
	</div> <!--main-->
